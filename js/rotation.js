...
const texture = new THREE.TextureLoader().load( "../models/low-angle-shot-mesmerizing-starry-sky.jpg" );
...
const mesh = new THREE.Mesh( geometry, material );mesh.position.set = (0,0,0)
scene.add(mesh)
...
function movearound()  
{
   ...
   // console.log("azimuthal",azimuthalAngle)
    ...
    {
        if (orbitCircumference >= 0.025 + i/popups.length && orbitCircumference < 0.18+ i/popups.length) 
        {
